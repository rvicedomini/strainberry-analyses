rule mock9_n2_barplots:
    input:
        ...
        "results/mock9/assembly_eval/sberry_canu_n2_scf.report.tsv",
        "results/mock9/assembly_eval/flye.report.tsv",
        "results/mock9/assembly_eval/sberry_flye_n2_scf.report.tsv",
    output:
        "results/mock9/assembly_eval/mock9_n2.asmstats.tsv",
        "results/mock9/assembly_eval/mock9_n2.ani.barplot.pdf",
        "results/mock9/assembly_eval/mock9_n2.dupratio.barplot.pdf",
    conda:
...
rule mock9_n2_circos_config:
    ...
    output: 
        'results/mock9/assembly_eval/circos_mock9_n2/etc/mock9_n2.conf',
        'results/mock9/assembly_eval/circos_mock9_n2/data/mock9_n2.karyotype.txt',
    shell:
        """
        mkdir -p results/mock9/assembly_eval/circos_mock9_n2 \
          && cp -rn resources/mock/circos/{{data,etc}} results/mock9/assembly_eval/circos_mock9_n2
        """
...
rule mock9_n2_circos_prepare:
    ...
    output:
        "results/mock9/assembly_eval/circos_mock9_n2/data/{assembly}.1coords.tsv",
        "results/mock9/assembly_eval/circos_mock9_n2/data/{assembly}.snps.int.tsv",
    shell:
        """
        : > {output[0]}
...
rule mock9_n2_circos_plot:
    input:
        'results/mock9/assembly_eval/circos_mock9_n2/etc/mock9_n2.conf',
        # aligned blocks
        'results/mock9/assembly_eval/circos_mock9_n2/data/canu.1coords.tsv',
        'results/mock9/assembly_eval/circos_mock9_n2/data/sberry_canu_n2_scf.1coords.tsv',
        'results/mock9/assembly_eval/circos_mock9_n2/data/flye.1coords.tsv',
        'results/mock9/assembly_eval/circos_mock9_n2/data/sberry_flye_n2_scf.1coords.tsv',
        # snps intervals
        'results/mock9/assembly_eval/circos_mock9_n2/data/canu.snps.int.tsv',
        'results/mock9/assembly_eval/circos_mock9_n2/data/sberry_canu_n2_scf.snps.int.tsv',
        'results/mock9/assembly_eval/circos_mock9_n2/data/flye.snps.int.tsv',
